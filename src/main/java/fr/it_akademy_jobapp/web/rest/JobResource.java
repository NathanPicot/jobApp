...
/**
 * REST controller for managing {@link fr.it_akademy_jobapp.domain.Job}.
 */
@RestController
...
public class JobResource {
     ...
     */
    @GetMapping("")
    public List<JobDTO> getAllJobs(@RequestParam(required = false, defaultValue = "true") boolean eagerload) {
